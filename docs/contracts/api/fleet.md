...
- Vehicle create/update validates type, plate, two-letter registration country, optional brand/model/year/capacity/volume/body type, refrigerated, hazmat, and active flags.
- License create/update validates license type and optional issued/expiry dates; expiry must be after issued date.
